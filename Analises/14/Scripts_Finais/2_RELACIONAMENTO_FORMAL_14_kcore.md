# SNA K-Core 2_RELACIONAMENTO FORMAL (var0)
Leonardo Martins  
17 de julho de 2016  
...
V(var0)$coreness<-graph.coreness(var0)
...
V(var0)$color_bar<-color_bar[coreness]
```
...
#Adding Title
  title("Coreness Colored Graph - 2_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](2_RELACIONAMENTO_FORMAL_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var0.RData") 
```
