# SNA K-Core 23_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).
Leonardo Martins  
17 de julho de 2016  
...
V(var21)$coreness<-graph.coreness(var21)
...
V(var21)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 23_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](23_CONFIANÇA_F_Confia_em_realizar_ações_conjuntas_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var21.RData") 
```
