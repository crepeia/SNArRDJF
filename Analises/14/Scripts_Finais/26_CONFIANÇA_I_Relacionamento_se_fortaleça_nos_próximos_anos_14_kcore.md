# SNA K-Core 26_CONFIANÇA I) Espera que o relacionamento com este serviço se fortaleça nos próximos anos. (var24)
Leonardo Martins  
17 de julho de 2016  
...
V(var24)$coreness<-graph.coreness(var24)
...
V(var24)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 26_CONFIANÇA I) Espera que o relacionamento com este serviço se fortaleça nos próximos anos. (var24)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](26_CONFIANÇA_I_Relacionamento_se_fortaleça_nos_próximos_anos_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var24.RData") 
```
