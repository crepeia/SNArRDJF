# SNA K-Core 15_ACESSO G) O acesso geográfico a este serviço impede a realização de ativades em conjunto. (var13) 
Leonardo Martins  
17 de julho de 2016  
...
V(var13)$coreness<-graph.coreness(var13)
...
V(var13)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 15_ACESSO G) O acesso geográfico a este serviço impede a realização de ativades em conjunto. (var13) ", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](15_ACESSO_G_O_acesso_geográfico_impede_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var13.RData") 
```
