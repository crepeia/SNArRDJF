# SNA K-Core 9_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)
Leonardo Martins  
17 de julho de 2016  
...
V(var7)$coreness<-graph.coreness(var7)
...
V(var7)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 9_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](9_ACESSO_A_realização_de_ativades_em_conjunto_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var7.RData") 
```
