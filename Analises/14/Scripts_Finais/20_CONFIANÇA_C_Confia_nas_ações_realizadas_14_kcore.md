# SNA K-Core 20_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)
Leonardo Martins  
17 de julho de 2016  
...
V(var18)$coreness<-graph.coreness(var18)
...
V(var18)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 20_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](20_CONFIANÇA_C_Confia_nas_ações_realizadas_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var18.RData") 
```
