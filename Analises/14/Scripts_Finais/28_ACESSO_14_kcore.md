...
V(acesso)$coreness<-graph.coreness(acesso)
...
V(acesso)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 28_ACESSO", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](28_ACESSO_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_acesso.RData") 
```
