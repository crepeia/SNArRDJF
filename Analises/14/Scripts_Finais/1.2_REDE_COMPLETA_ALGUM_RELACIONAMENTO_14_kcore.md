# SNA K-Core 1.2 - ALGUM RELACIONAMENTO (x2)
Leonardo Martins  
17 de julho de 2016  
...
V(x2)$coreness<-graph.coreness(x2)
...
V(x2)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 1.2 - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](1.2_REDE_COMPLETA_ALGUM_RELACIONAMENTO_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_x2.RData") 
```
