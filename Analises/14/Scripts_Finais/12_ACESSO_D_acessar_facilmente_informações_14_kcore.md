# SNA K-Core 12_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)
Leonardo Martins  
17 de julho de 2016  
...
V(var10)$coreness<-graph.coreness(var10)
...
V(var10)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 12_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](12_ACESSO_D_acessar_facilmente_informações_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var10.RData") 
```
