# SNA K-Core 25_CONFIANÇA H) Espera que o relacionamento com este serviço continue nos próximos anos (var23).
Leonardo Martins  
17 de julho de 2016  
...
V(var23)$coreness<-graph.coreness(var23)
...
V(var23)$color_bar<-color_bar[coreness]
...
#Adding Title
  title("Coreness Colored Graph - 25_CONFIANÇA H) Espera que o relacionamento com este serviço continue nos próximos anos (var23).", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](25_CONFIANÇA_H_Relacionamento_continue_nos_próximos_anos_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var23.RData") 
```
