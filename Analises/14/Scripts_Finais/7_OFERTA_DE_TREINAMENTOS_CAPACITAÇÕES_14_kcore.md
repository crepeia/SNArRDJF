# SNA K-Core 7_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)
Leonardo Martins  
17 de julho de 2016  
...
V(var5)$coreness<-graph.coreness(var5)
...
V(var5)$color_bar<-color_bar[coreness]
```
...
#Adding Title
  title("Coreness Colored Graph - 7_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ", cex = .5)
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
...
![](7_OFERTA_DE_TREINAMENTOS_CAPACITAÇÕES_14_kcore_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

#Saving objects with new variables and changes

```r
save.image("~/SNArRDJF/Robject/14_kcore_var5.RData") 
```
