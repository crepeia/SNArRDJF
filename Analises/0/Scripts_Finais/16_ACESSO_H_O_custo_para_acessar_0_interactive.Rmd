---
title: "SNA Interactive Plotting 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
...
load("~/SNArRDJF/Robject/var14.RData")
```
##Reload packages
...
#Removing CAPS AD
```{r}
#make_ego_graph_all_var14_without_CAPSAD<-delete_vertices(var14,V(var14)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
#var14<-make_ego_graph_all_var14_without_CAPSAD
```
...
```
#Interactive Plotting - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
