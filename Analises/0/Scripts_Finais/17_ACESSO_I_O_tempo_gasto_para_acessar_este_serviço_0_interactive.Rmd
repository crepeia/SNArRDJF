---
title: "SNA Interactive Plotting 17_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
...
load("~/SNArRDJF/Robject/var15.RData")
```
##Reload packages
