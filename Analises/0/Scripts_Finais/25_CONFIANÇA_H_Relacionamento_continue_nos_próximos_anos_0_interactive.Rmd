---
title: "SNA Interactive Plotting 25_CONFIANÇA H) Espera que o relacionamento com este serviço continue nos próximos anos (var23)."
...
load("~/SNArRDJF/Robject/var23.RData")
```
##Reload packages
...
#Removing CAPS AD
```{r}
#make_ego_graph_all_var23_without_CAPSAD<-delete_vertices(var23,V(var23)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
#var23<-make_ego_graph_all_var23_without_CAPSAD
```
...
```
#Interactive Plotting - 25_CONFIANÇA H) Espera que o relacionamento com este serviço continue nos próximos anos (var23).
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
