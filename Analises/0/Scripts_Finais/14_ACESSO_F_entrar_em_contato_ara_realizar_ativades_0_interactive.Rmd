---
title: "SNA Interactive Plotting 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
...
load("~/SNArRDJF/Robject/var12.RData")
```
##Reload packages
...
#Removing CAPS AD
```{r}
#make_ego_graph_all_var12_without_CAPSAD<-delete_vertices(var12,V(var12)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
#var12<-make_ego_graph_all_var12_without_CAPSAD
```
...
```
#Interactive Plotting - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
