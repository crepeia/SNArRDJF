---
title: "SNA Diameter 13_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)"
...
diameter(var11, weights = E(var11)$equalone)
var11_dim<-get.diameter(var11, weights=E(var11)$equalone)
var11_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
