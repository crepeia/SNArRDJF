---
title: "SNA Diameter 12_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)"
...
diameter(var10, weights = E(var10)$equalone)
var10_dim<-get.diameter(var10, weights=E(var10)$equalone)
var10_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
