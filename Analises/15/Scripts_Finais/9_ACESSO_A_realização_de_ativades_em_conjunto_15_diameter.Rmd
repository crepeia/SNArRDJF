---
title: "SNA Diameter 9_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)"
...
diameter(var7, weights = E(var7)$equalone)
var7_dim<-get.diameter(var7, weights=E(var7)$equalone)
var7_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
