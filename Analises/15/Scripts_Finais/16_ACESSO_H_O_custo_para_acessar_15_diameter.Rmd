---
title: "SNA Diameter 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
...
diameter(var14, weights = E(var14)$equalone)
var14_dim<-get.diameter(var14, weights=E(var14)$equalone)
var14_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
