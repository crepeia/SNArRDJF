---
title: "SNA Diameter 23_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21)."
...
diameter(var21, weights = E(var21)$equalone)
var21_dim<-get.diameter(var21, weights=E(var21)$equalone)
var21_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
