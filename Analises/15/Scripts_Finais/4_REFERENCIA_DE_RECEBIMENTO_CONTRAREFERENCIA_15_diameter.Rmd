---
title: "SNA Diameter 4_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)"
...
diameter(var2, weights = E(var2)$equalone)
var2_dim<-get.diameter(var2, weights=E(var2)$equalone)
var2_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
