...
node_list <- get.data.frame(x2, what = "vertices")

#Writing Node CSV 
write.csv2(node_list, "~/SNArRDJF/Banco Redes R/Networks/node_x2.csv", fileEncoding = "macintosh")

# Edge List
edge_list <- get.data.frame(x2, what = "edges") %>%
...
write.csv2(edge_list, "~/SNArRDJF/Banco Redes R/Networks/edge_x2.csv", fileEncoding = "macintosh")
...
```{r}
save.image("~/SNArRDJF/2.SNA.x2.RData") 
```
