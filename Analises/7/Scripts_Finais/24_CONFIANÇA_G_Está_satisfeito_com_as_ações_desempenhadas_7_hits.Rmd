---
title: "SNA HITS 24_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22)."
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO1, var22_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO2, var22_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO1, var22_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO2, var22_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO1, var22_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$TIPO2, var22_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
