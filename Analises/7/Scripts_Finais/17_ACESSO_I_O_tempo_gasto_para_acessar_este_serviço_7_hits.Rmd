---
title: "SNA HITS 17_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO1, var15_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO2, var15_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO1, var15_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO2, var15_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO1, var15_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$TIPO2, var15_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
