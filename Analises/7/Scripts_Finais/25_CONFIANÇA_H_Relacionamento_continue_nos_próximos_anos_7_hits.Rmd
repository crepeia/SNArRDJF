---
title: "SNA HITS 25_CONFIANÇA H) Espera que o relacionamento com este serviço continue nos próximos anos (var23)."
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO1, var23_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Hubs Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO2, var23_hub))
names(d)<-c("Type", "Hub Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO1, var23_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##Authorities Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO2, var23_auth))
names(d)<-c("Type", "Authorities Score")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO1, var23_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
...
##PageRank Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var23)$TIPO2, var23_pr))
names(d)<-c("Type", "Page Rank")
datatable(d, filter ="top")
```
