...
full_no_zero_node_list <- get.data.frame(full_no_zero, what = "vertices")

#Write Node List
write.csv(full_no_zero_node_list, "~/SNArRDJF/Banco Redes R/Bancos CSV/full_no_zero_node_list_df.csv")

# Determine a community for each edge. If two nodes belong to the
# same community, label the edge with that community. If not,
# the edge community value is 'NA'
full_no_zero_edge_list <- get.data.frame(full_no_zero, what = "edges") %>%
