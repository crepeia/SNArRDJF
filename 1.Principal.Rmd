...
#Writing full_no_zero graph
```{r}
save(full_no_zero, file = "~/SNArRDJF/Robject/full_no_zero.RData")
```
...
```{r}
save(full_no_zero, file = "~/SNArRDJF/Robject/full_no_zero.RData")
save(x2, file = "~/SNArRDJF/Robject/x2.RData")
save(var0, file = "~/SNArRDJF/Robject/var0.RData")  
save(var1, file = "~/SNArRDJF/Robject/var1.RData")  
save(var2, file = "~/SNArRDJF/Robject/var2.RData")  
save(var3, file = "~/SNArRDJF/Robject/var3.RData")  
save(var4, file = "~/SNArRDJF/Robject/var4.RData")  
save(var5, file = "~/SNArRDJF/Robject/var5.RData")  
save(var6, file = "~/SNArRDJF/Robject/var6.RData")  
save(var7, file = "~/SNArRDJF/Robject/var7.RData")  
save(var8, file = "~/SNArRDJF/Robject/var8.RData")  
save(var9, file = "~/SNArRDJF/Robject/var9.RData")  
save(var10, file = "~/SNArRDJF/Robject/var10.RData")  
save(var11, file = "~/SNArRDJF/Robject/var11.RData")
save(var12, file = "~/SNArRDJF/Robject/var12.RData")
save(var13, file = "~/SNArRDJF/Robject/var13.RData")  
save(var14, file = "~/SNArRDJF/Robject/var14.RData")
save(var15, file = "~/SNArRDJF/Robject/var15.RData")
save(var16, file = "~/SNArRDJF/Robject/var16.RData")
save(var17, file = "~/SNArRDJF/Robject/var17.RData")
save(var18, file = "~/SNArRDJF/Robject/var18.RData")
save(var19, file = "~/SNArRDJF/Robject/var19.RData")
save(var20, file = "~/SNArRDJF/Robject/var20.RData")
save(var21, file = "~/SNArRDJF/Robject/var21.RData")
save(var22, file = "~/SNArRDJF/Robject/var22.RData")
save(var23, file = "~/SNArRDJF/Robject/var23.RData")
save(var24, file = "~/SNArRDJF/Robject/var24.RData")
save(atividade, file = "~/SNArRDJF/Robject/atividade.RData")
save(acesso, file = "~/SNArRDJF/Robject/acesso.RData")
save(acesso_positivo, file = "~/SNArRDJF/Robject/acesso_positivo.RData")
save(acesso_negativo, file = "~/SNArRDJF/Robject/acesso_negativo.RData")
save(confianca, file = "~/SNArRDJF/Robject/confianca.RData")
save(acessoeconfianca, file ="~/SNArRDJF/Robject/acessoeconfianca.Rdata")
save(total, file = "~/SNArRDJF/Robject/total.RData")
```
