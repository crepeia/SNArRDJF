...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
##Histogram var6_with_CAPS degree - All
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var6_with_CAPS, weights=E(var6_with_CAPS)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6_with_CAPS, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6_with_CAPS)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var6_with_CAPS), breaks=vcount(var6_with_CAPS)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
