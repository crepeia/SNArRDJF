...
load("~/SNArRDJF/Robject/var5.RData")
```
##Reload packages
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
##Histogram var5_without_CAPS degree - All
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var5_without_CAPS, weights=E(var5_without_CAPS)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5_without_CAPS, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5_without_CAPS)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=TRUE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var5_without_CAPS), breaks=vcount(var5_without_CAPS)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
