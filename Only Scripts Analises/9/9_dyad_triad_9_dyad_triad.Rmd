...
#Transitivity  Measures Dinamic Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
full_no_zero_transitivity_df <-cbind(full_no_zero_transitivity_df, V(full_no_zero)$TIPO1)
...
#Transitivity  Measures Dinamic Table
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
full_no_zero_transitivity_df <-cbind(full_no_zero_transitivity_df, V(full_no_zero)$TIPO2)
