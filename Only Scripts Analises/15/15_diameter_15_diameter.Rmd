...
diameter(full_no_zero, weights = E(full_no_zero)$equalone)
full_no_zero_dim<-get.diameter(full_no_zero, weights=E(full_no_zero)$equalone)
full_no_zero_dim
```
##Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Diameter of fuull_no_zero_fancy", sub = "Source: from authors ")
  text( 
    x=range(co[,1])[1],
    y=range(co[,2])[1], 
